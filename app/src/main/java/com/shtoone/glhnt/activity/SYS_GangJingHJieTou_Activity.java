...
public class SYS_GangJingHJieTou_Activity extends Activity implements OnDoubleTapListener, OnGestureListener, OnTouchListener {
...
//    private List<COM_SheBei_Entity> shebeiList;
    ...
    private TextView tv_title_page, tv_selectdevice;
    ...
    private void beforeStart() throws IOException {
        ...
        dp = new DataPropertiy(SYS_GangJingHJieTou_Activity.this);
        ((TextView) this.findViewById(R.id.project_title)).setText(xmmc + " > " + getResources().getString(R.string.sys) + " > 钢筋焊接");
    ...
    private void setProgressDialog() {
        mypDialog = new ProgressDialog(SYS_GangJingHJieTou_Activity.this);
    ...
    private void createHandler() {
        handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                if (msg.what == 0) {
                    mypDialog.dismiss();
                    Toast.makeText(SYS_GangJingHJieTou_Activity.this, "暂无数据！", Toast.LENGTH_SHORT).show();
        ...
        new Thread(new Runnable() {
            public void run() {
                try {
                    ...
                    data = service.getGJHJJTDataList(userGroupID, isQualified, startTime, endTime, current_PageNo,device,"0",testType);
                    Thread.sleep(500);
    ...
    protected void setAdapter() {
        tv_title_page.setText("第" + current_PageNo + "页");
        listView.setAdapter(new SYS_GangJingLaLiAdapter(SYS_GangJingHJieTou_Activity.this, data.getData(),"2"));
    }
        ...
        et1.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePicker dateTimePicKDialog = new DatePicker(
                        SYS_GangJingHJieTou_Activity.this, startTime);
        ...
        et2.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (isShown)
                    moveLayout();
                DatePicker dateTimePicKDialog = new DatePicker(
                        SYS_GangJingHJieTou_Activity.this, endTime);
        ...
        btn_search.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(Integer.valueOf(CommFunctions.ChangeTimeToLong(startTime)) > Integer.valueOf(CommFunctions.ChangeTimeToLong(endTime)) ){
                    Toast.makeText(SYS_GangJingHJieTou_Activity.this, "开始日期不能大于结束日期！", Toast.LENGTH_SHORT).show();
                    mypDialog.dismiss();
                    return;
                }
                startLoadListThread();
...
//                moveLayout();
                AlertDialog.Builder builder = new AlertDialog.Builder(SYS_GangJingHJieTou_Activity.this);
        ...
        weather_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if("GL".equals(dengji)) {
                    Intent intent = new Intent(SYS_GangJingHJieTou_Activity.this, CommZuhijiegou.class);
    ...
    public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
        if (e1.getX() - e2.getX() > FLING_MIN_DISTANCE
            ...
            if (index - 1 <= 0) {
                current_PageNo = "1";
                Toast.makeText(SYS_GangJingHJieTou_Activity.this, "当前已为第一页！", Toast.LENGTH_SHORT).show();
            } else {
    ...
    public boolean onSingleTapUp(MotionEvent e) {
        if (NetWorkingUtil.isConn(SYS_GangJingHJieTou_Activity.this)) {
            int x = (int) e.getX();
            int y = (int) e.getY();
            ...
            Intent intent = new Intent(SYS_GangJingHJieTou_Activity.this, SYS_GangJingLaLi_XqActivity.class);
            ...
            Toast.makeText(SYS_GangJingHJieTou_Activity.this, "无网络连接！", Toast.LENGTH_SHORT).show();
        }
        return false;
    }
    ...
    protected void onActivityResult(int arg0, int arg1, Intent arg2) {
        try {
            ...
            if(!"".equals(arg2.getStringExtra("selectedGroupName")) && arg2.getStringExtra("selectedGroupName") != null) {
                ((TextView) this.findViewById(R.id.project_title)).setText(arg2.getStringExtra("selectedGroupName") + " > " + getResources().getString(R.string.sys) + " > 钢筋焊接");
            ...
            //Toast.makeText(SYS_GangJingHJieTou_Activity.this, ex.getMessage(), Toast.LENGTH_SHORT).show();
        }
    }
