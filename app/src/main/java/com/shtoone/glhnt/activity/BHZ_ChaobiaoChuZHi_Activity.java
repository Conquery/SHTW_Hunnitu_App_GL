...
public class BHZ_ChaobiaoChuZHi_Activity extends Activity implements OnDoubleTapListener, OnGestureListener, OnTouchListener {
    ...
    private boolean chuzhi;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        this.requestWindowFeature(Window.FEATURE_CUSTOM_TITLE);
        this.setContentView(R.layout.activity_bhz_chaobiaochuzhi);
    ...
    private void beforeStart() throws IOException {
        dp = new DataPropertiy(BHZ_ChaobiaoChuZHi_Activity.this);
        ...
        ((TextView) this.findViewById(R.id.project_title)).setText(xmmc + " > " + getResources().getString(R.string.bhz) + " > 待处置报警");
    ...
    private void setListener() {
        ...
        radioButton3.setText("未审批");
        radioButton4.setText("已审批");
        ...
        et1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DateTimePicker dateTimePicKDialog = new DateTimePicker(
                        BHZ_ChaobiaoChuZHi_Activity.this, startTime);
        ...
        et2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isShown)
                    moveLayout();
                DateTimePicker dateTimePicKDialog = new DateTimePicker(
                        BHZ_ChaobiaoChuZHi_Activity.this, endTime);
        ...
        btn_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(Integer.valueOf(CommFunctions.ChangeTimeToLong(startTime)) > Integer.valueOf(CommFunctions.ChangeTimeToLong(endTime)) ){
                    Toast.makeText(BHZ_ChaobiaoChuZHi_Activity.this, "开始日期不能大于结束日期！", Toast.LENGTH_SHORT).show();
                    mypDialog.dismiss();
                    return;
                }
                startLoadListThread();
        ...
        tv_selectshebei.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //moveLayout();
                AlertDialog.Builder builder = new AlertDialog.Builder(BHZ_ChaobiaoChuZHi_Activity.this);
        ...
        weather_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if ("GL".equals(dengji)) {
                    Intent intent = new Intent(BHZ_ChaobiaoChuZHi_Activity.this, CommZuhijiegou.class);
    ...
    private void createHandler() {
        handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                mypDialog.dismiss();
                if (msg.what == 0) {
                    Toast.makeText(BHZ_ChaobiaoChuZHi_Activity.this, "已无更多数据！", Toast.LENGTH_SHORT).show();
                }
                if (msg.what == 1) {
                    setAdapter();
                }
    ...
    protected void setAdapter() {
        tv_title_page.setText("第" + current_PageNo + "页");
        listView.setAdapter(new BHZ_ScshujuchaxunAdapter(BHZ_ChaobiaoChuZHi_Activity.this, data, currentType));
    }
    ...
    private void startLoadListThread() {
        new Thread(new Runnable() {
            public void run() {
                try {
                    Log.d("当前页码", current_PageNo);
                    //只获取一次
                    if(dev_list == null){
                        dev_list = service.getCOMM_Shebei(userGroupID, "1","BHZ");
                    }
                    Thread.sleep(500);
                    data = service.getBhzChaobiaoList(userGroupID, startTime, endTime, "0", String.valueOf(currentType), current_PageNo,device);
                    Thread.sleep(500);
    ...
    private void setProgressDialog() {
        mypDialog = new ProgressDialog(BHZ_ChaobiaoChuZHi_Activity.this);
    ...
    private void findView() {
        ...
        radioButton3 = (RadioButton) this.findViewById(R.id.radio_sp);
        radioButton4 = (RadioButton) this.findViewById(R.id.radio_wsp);
        if("CZ".equals(role)){
            radioButton3.setVisibility(View.GONE);
            radioButton4.setVisibility(View.GONE);
        }else if("SP".equals(role) && !chuzhi){
    ...
    public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
        if (e1.getX() - e2.getX() > FLING_MIN_DISTANCE
            ...
            if (index - 1 <= 0) {
                current_PageNo = "1";
                Toast.makeText(BHZ_ChaobiaoChuZHi_Activity.this, "当前已为第一页！", Toast.LENGTH_SHORT).show();
            } else {
    ...
    public boolean onSingleTapUp(MotionEvent e) {
        if (NetWorkingUtil.isConn(BHZ_ChaobiaoChuZHi_Activity.this)) {
            int x = (int) e.getX();
            int y = (int) e.getY();
            ...
            Intent intent = new Intent(BHZ_ChaobiaoChuZHi_Activity.this, BHZ_ChaobiaoChuZHi_XqActivity.class);
            Bundle bundle = new Bundle();
            bundle.putString("xmmc", xmmc);
            bundle.putString("xqID", item.getBianhao());
            bundle.putString("shebeibianhao", item.getShebeibianhao());
            bundle.putString("Title_Name", xmmc + " > " + item.getmName());
            bundle.putString("userFullName", userFullName);
            if(currentType == 0 || currentType == 1)
                bundle.putString("role", "CZ");
            else
                bundle.putString("role", role);
            bundle.putBoolean("chuzhi", chuzhi);
            intent.putExtras(bundle);
            startActivityForResult(intent, 1);
        } else {
            Toast.makeText(BHZ_ChaobiaoChuZHi_Activity.this, "网络不可用,请联网!", Toast.LENGTH_SHORT).show();
        }
        return false;
    }
    ...
    protected void onActivityResult(int arg0, int arg1, Intent arg2) {
        try {
            ...
            if(!"".equals(arg2.getStringExtra("selectedGroupName")) && arg2.getStringExtra("selectedGroupName") != null) {
                ((TextView) this.findViewById(R.id.project_title)).setText(arg2.getStringExtra("selectedGroupName") + " > " + getResources().getString(R.string.bhz) + " > 超标处置");
