...
import com.shtoone.glhnt.adapter.SYS_HunNiTuAdapter;
...
public class SYS_HuNiTuQiangDu_Activity extends Activity implements OnDoubleTapListener, OnGestureListener, OnTouchListener {
    ...
    private RadioButton radioButton1, radioButton2,radioButton3, radioButton4;  //合格   不合格  有效   无效
    private String xmmc;
...
//    private List<COM_SheBei_Entity> shebeiList;
    private SYS_HunNiTu_Entity data;
    private ProgressDialog mypDialog;
    private String current_PageNo = "1";
    private String startTime = "2015-09-01", endTime = "2015-09-30";
    private EditText et1, et2;
    private TextView btn_search, tv_title_page, tv_selectshebei,tv_selectTestType;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hunnituqiangdu);
    ...
    private void beforeStart() throws IOException {
        ...
        dp = new DataPropertiy(SYS_HuNiTuQiangDu_Activity.this);
    ...
    private void setProgressDialog() {
        mypDialog = new ProgressDialog(SYS_HuNiTuQiangDu_Activity.this);
    ...
    private void createHandler() {
        handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                if (msg.what == 0) {
                    mypDialog.dismiss();
                    Toast.makeText(SYS_HuNiTuQiangDu_Activity.this,"暂无数据！", Toast.LENGTH_SHORT).show();
    ...
    private void beforeStartLoadListThread() {
        mypDialog.show();
        current_PageNo = "1";
        tv_title_page.setText("??" + current_PageNo + "?");
        ...
        new Thread(new Runnable() {
            public void run() {
                try {
                    //只获取一次
                    if (dev_list == null) {
                        dev_list = service.getCOMM_Shebei(userGroupID, "4", "SYS");
                        Thread.sleep(500);
                    }
                    if (testType_list == null) {
                        testType_list = service.getCOMM_GangJinTestType(API.YalijiTestType);
                        Thread.sleep(500);
                    }
                    data = service.getHNTQDDataList(userGroupID, isQualified, startTime, endTime, current_PageNo, device, "0",testType);
                    Thread.sleep(500);
    ...
    protected void setAdapter() {
        ...
        listView.setAdapter(new SYS_HunNiTuAdapter(SYS_HuNiTuQiangDu_Activity.this, data.getData()));
    }
    ...
    private void findView() {
        ...
        radioButton3 = (RadioButton) this.findViewById(R.id.radio_youxiao);
        radioButton4 = (RadioButton) this.findViewById(R.id.radio_wuxiao);
    ...
    private void setListener() {
        ...
        et1.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePicker dateTimePicKDialog = new DatePicker(SYS_HuNiTuQiangDu_Activity.this, startTime);
        ...
        et2.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                DatePicker dateTimePicKDialog = new DatePicker(
                        SYS_HuNiTuQiangDu_Activity.this, endTime);
                dateTimePicKDialog.dateTimePicKDialog(et2);
            }
        });
        tv_selectshebei.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                //                layoutDevice.setVisibility(View.VISIBLE);
//                moveLayout();
                AlertDialog.Builder builder = new AlertDialog.Builder(SYS_HuNiTuQiangDu_Activity.this);
        ...
        btn_search.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Integer.valueOf(CommFunctions.ChangeTimeToLong(startTime)) > Integer.valueOf(CommFunctions.ChangeTimeToLong(endTime))) {
                    Toast.makeText(SYS_HuNiTuQiangDu_Activity.this, "开始日期不能大于结束日期！", Toast.LENGTH_SHORT).show();
                    mypDialog.dismiss();
                    return;
                }
                startLoadListThread();
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                beforeStartLoadListThread();
                if (checkedId == radioButton1.getId()) {  //合格
                    isQualified = "1";
                }
                if (checkedId == radioButton2.getId()) {  //不合格
                    isQualified = "0";
                }
                if (checkedId == radioButton3.getId()) {  //有效
                    isQualified = "2";
                }
                if (checkedId == radioButton4.getId()) {  //无效
                    isQualified = "3";
                }
                startLoadListThread();
            }
        ...
        weather_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if ("GL".equals(dengji)) {
                    Intent intent = new Intent(SYS_HuNiTuQiangDu_Activity.this, CommZuhijiegou.class);
...
//                isShown = true;
    ...
    public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
        if (e1.getX() - e2.getX() > FLING_MIN_DISTANCE
            ...
            if (index - 1 <= 0) {
                current_PageNo = "1";
                Toast.makeText(SYS_HuNiTuQiangDu_Activity.this,"当前已为第一页！", Toast.LENGTH_SHORT).show();
            } else {
    ...
    public boolean onSingleTapUp(MotionEvent e) {
        if (NetWorkingUtil.isConn(SYS_HuNiTuQiangDu_Activity.this)) {
            int x = (int) e.getX();
            int y = (int) e.getY();
            int position = listView.pointToPosition(x, y);
            int firstVisiblePosition = listView.getFirstVisiblePosition();
            int itemIndex = listView.pointToPosition((int) e.getX(), (int) e.getY());
            SYS_HunNiTu_Entity.DataEntity item = (SYS_HunNiTu_Entity.DataEntity) listView.getItemAtPosition(itemIndex);
            Intent intent = new Intent(SYS_HuNiTuQiangDu_Activity.this, SYS_HuNiTuQiangDu_XqActivity.class);
            ...
            Toast.makeText(SYS_HuNiTuQiangDu_Activity.this, "无网络连接！", Toast.LENGTH_SHORT).show();
        }
        return false;
    }
    ...
    protected void onActivityResult(int arg0, int arg1, Intent arg2) {
        try {
            ...
            if (!"".equals(arg2.getStringExtra("selectedGroupName")) && arg2.getStringExtra("selectedGroupName") != null) {
                ((TextView) this.findViewById(R.id.project_title)).setText(arg2.getStringExtra("selectedGroupName") + " > " + getResources().getString(R.string.sys) + " > 压力试验");
