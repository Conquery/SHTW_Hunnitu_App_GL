...
public class SYS_Yaliji_BuHeGeSYChuZhi_Activity extends Activity implements OnDoubleTapListener, OnGestureListener, OnTouchListener {
    ...
    private String currentType = "1";  //处置类型

    private String userFullName = "", userRole = "";

    private String device = "";
    private COMM_Shebei dev_list,dev_list2 = null;
    ...
    private void beforeStart() throws IOException {
        dp = new DataPropertiy(SYS_Yaliji_BuHeGeSYChuZhi_Activity.this);
        xmmc = getIntent().getStringExtra("xmmc");
        dengji = getIntent().getStringExtra("dengji");
        userRole = getIntent().getStringExtra("userRole");
        ((TextView) this.findViewById(R.id.project_title)).setText(xmmc + " > " + getResources().getString(R.string.sys) + " > 压力试验不合格处置");
    ...
    private void createHandler() {
        handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                if (msg.what == 0) {
                    mypDialog.dismiss();
                    Toast.makeText(SYS_Yaliji_BuHeGeSYChuZhi_Activity.this, "已无更多数据！", Toast.LENGTH_SHORT).show();
    ...
    protected void setAdapter() {
        ...
        listView.setAdapter(new SYS_BuHeGeChuZhiAdapter(SYS_Yaliji_BuHeGeSYChuZhi_Activity.this, data, currentType));
    }
        ...
        new Thread(new Runnable() {
            public void run() {
                try {
                    ...
                    if (dev_list == null) {
                        //TODO：祝鹏辉
                        dev_list = service.getCOMM_Shebei(userGroupID, "4", "SYS");  //压力机
                        Thread.sleep(500);
                    }
                    ...
                    data = service.getYalijiSysBuhegeData(userGroupID, startTime, endTime, current_PageNo, currentType, device,testType);
                    Thread.sleep(500);
                    //******************************************
    ...
    private void setListener() {
        ...
        et1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePicker dateTimePicKDialog = new DatePicker(SYS_Yaliji_BuHeGeSYChuZhi_Activity.this, startTime);
        ...
        et2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePicker dateTimePicKDialog = new DatePicker(SYS_Yaliji_BuHeGeSYChuZhi_Activity.this, endTime);
...
//                moveLayout();
                AlertDialog.Builder builder = new AlertDialog.Builder(SYS_Yaliji_BuHeGeSYChuZhi_Activity.this);
        ...
        btn_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Integer.valueOf(CommFunctions.ChangeTimeToLong(startTime)) > Integer.valueOf(CommFunctions.ChangeTimeToLong(endTime))) {
                    Toast.makeText(SYS_Yaliji_BuHeGeSYChuZhi_Activity.this, "开始日期不能大于结束日期！", Toast.LENGTH_SHORT).show();
                    mypDialog.dismiss();
                    return;
                }
                startLoadListThread();
        ...
        //选择试验类型
        tv_selectTestType.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(SYS_Yaliji_BuHeGeSYChuZhi_Activity.this);
                builder.setIcon(R.drawable.right);
        ...
        weather_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if ("GL".equals(dengji)) {
                    Intent intent = new Intent(SYS_Yaliji_BuHeGeSYChuZhi_Activity.this, CommZuhijiegou.class);
    ...
    private void setProgressDialog() {
        mypDialog = new ProgressDialog(SYS_Yaliji_BuHeGeSYChuZhi_Activity.this);
    ...
    public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
        if (e1.getX() - e2.getX() > FLING_MIN_DISTANCE
            ...
            if (index - 1 <= 0) {
                current_PageNo = "1";
                Toast.makeText(SYS_Yaliji_BuHeGeSYChuZhi_Activity.this, "当前已为第一页！", Toast.LENGTH_SHORT).show();
            } else {
    ...
    public boolean onSingleTapUp(MotionEvent e) {
        if (NetWorkingUtil.isConn(SYS_Yaliji_BuHeGeSYChuZhi_Activity.this)) {
            int x = (int) e.getX();
            int y = (int) e.getY();
            ...
            Log.e("xqid", "xqid:" + item.getId());

            Intent intent = new Intent(SYS_Yaliji_BuHeGeSYChuZhi_Activity.this, SYS_HuNiTuQiangDu_XqActivity.class);
            ...
            Toast.makeText(SYS_Yaliji_BuHeGeSYChuZhi_Activity.this, "网络不可用,请联网!", Toast.LENGTH_SHORT).show();
        }
        return false;
    }
