...
public class SYS_GangJingJXLJJieTou_Activity extends Activity implements OnDoubleTapListener, OnGestureListener, OnTouchListener {
...
//    private List<COM_SheBei_Entity> shebeiList;
    ...
    private void beforeStart() throws IOException {
        ...
        ((TextView) this.findViewById(R.id.project_title)).setText(xmmc + " > 试验室管理 > 钢筋连接");
        service = new ServiceDao();
        userGroupID = getIntent().getStringExtra("userGroupID");
        dp = new DataPropertiy(SYS_GangJingJXLJJieTou_Activity.this);
    ...
    private void setProgressDialog() {
        mypDialog = new ProgressDialog(SYS_GangJingJXLJJieTou_Activity.this);
    ...
    private void createHandler() {
        handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                if (msg.what == 0) {
                    mypDialog.dismiss();
                    Toast.makeText(SYS_GangJingJXLJJieTou_Activity.this, "已无更多数据！", Toast.LENGTH_SHORT).show();
        ...
        new Thread(new Runnable() {
            public void run() {
                try {
                    ...
                    data = service.getGJJXLJJTDataList(userGroupID, isQualified, startTime, endTime, current_PageNo,device,"0",testType);
                    Thread.sleep(500);
    ...
    protected void setAdapter() {
        tv_title_page.setText("第" + current_PageNo + "页");
        listView.setAdapter(new SYS_GangJingLaLiAdapter(SYS_GangJingJXLJJieTou_Activity.this, data.getData(),"3"));
    }
    ...
    private void setListener() {
        ...
        et1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePicker dateTimePicKDialog = new DatePicker(
                        SYS_GangJingJXLJJieTou_Activity.this, startTime);
        ...
        et2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePicker dateTimePicKDialog = new DatePicker(
                        SYS_GangJingJXLJJieTou_Activity.this, endTime);
...
//                mypDialog.show();
                ...
                if(Integer.valueOf(CommFunctions.ChangeTimeToLong(startTime)) > Integer.valueOf(CommFunctions.ChangeTimeToLong(endTime)) ){
                    Toast.makeText(SYS_GangJingJXLJJieTou_Activity.this, "开始日期不能大于结束日期！", Toast.LENGTH_SHORT).show();
                    mypDialog.dismiss();
                    return;
                }
                startLoadListThread();
...
//                moveLayout();
                AlertDialog.Builder builder = new AlertDialog.Builder(SYS_GangJingJXLJJieTou_Activity.this);
        ...
        weather_img.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SYS_GangJingJXLJJieTou_Activity.this, CommZuhijiegou.class);
    ...
    public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
        if (e1.getX() - e2.getX() > FLING_MIN_DISTANCE
            ...
            if (index - 1 <= 0) {
                current_PageNo = "1";
                Toast.makeText(SYS_GangJingJXLJJieTou_Activity.this, "当前已为第一页！", Toast.LENGTH_SHORT).show();
            } else {
    ...
    public boolean onSingleTapUp(MotionEvent e) {
        if (NetWorkingUtil.isConn(SYS_GangJingJXLJJieTou_Activity.this)) {
            int x = (int) e.getX();
            int y = (int) e.getY();
            ...
            Intent intent = new Intent(SYS_GangJingJXLJJieTou_Activity.this, SYS_GangJingLaLi_XqActivity.class);
            ...
            Toast.makeText(SYS_GangJingJXLJJieTou_Activity.this, "网络不可用,请联网!", Toast.LENGTH_SHORT).show();
        }
        return false;
    }
    ...
    protected void onActivityResult(int arg0, int arg1, Intent arg2) {
        try {
            ...
            if(!"".equals(arg2.getStringExtra("selectedGroupName")) && arg2.getStringExtra("selectedGroupName") != null) {
                ((TextView) this.findViewById(R.id.project_title)).setText(arg2.getStringExtra("selectedGroupName") + " > 拌和站管理 > 钢筋连接");
            ...
            //Toast.makeText(SYS_GangJingJXLJJieTou_Activity.this, ex.getMessage(), Toast.LENGTH_SHORT).show();
        }
    }
